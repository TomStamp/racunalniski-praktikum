...
\subsubsection{Merjenje kakovosti} % podrazdelek
...
kršitev omejitve \emph{n}, z $u_{n}$ pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
$$
k_{1} \cdot u_{1} + k_{2} \cdot u_{2} + \dots + k_{n-1} \cdot u_{n-1} + k_{n} u_{n}
$$
...
Naj bo $n=100$ ter ${s}_{1}$ sprememba urnika, ki nas je pripeljala v lokalni maksimum. To
...
se sprememba ${s}_{1}$, ki vodi do lokalnega maksimuma, šele tedaj izbriše iz seznama
